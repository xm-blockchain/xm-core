...
from xm.generated.xmbase_pb2 import GetNodeInfoReq, GetNodeInfoResp
from xm.generated.xmbase_pb2_grpc import BaseServicer
...
class BaseService(BaseServicer):
    ...
    def GetNodeInfo(self, request: GetNodeInfoReq, context) -> GetNodeInfoResp:
        try:
            ...
            resp.version = self.xmnode.version

            pkgdir = os.path.dirname(sys.modules['xm'].__file__)
            grpcprotopath = os.path.join(pkgdir, "protos", "xm.proto")
