...
from xm.core.Singleton import Singleton
from xm.core.miners.qryptonight7.CNv1PoWValidator import CNv1PoWValidator
from xm.core.miners.qrandomx.QRXPoWValidator import QRXPoWValidator
