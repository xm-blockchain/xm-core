...
from xm.generated.xmlegacy_pb2 import LegacyMessage
...
class MessageReceipt(object):
    ...
    services_arg = {
        ######################
        xmlegacy_pb2.LegacyMessage.VE: 'veData',
        xmlegacy_pb2.LegacyMessage.PL: 'plData',
        xmlegacy_pb2.LegacyMessage.PONG: 'pongData',

        ######################
        xmlegacy_pb2.LegacyMessage.MR: 'mrData',
        xmlegacy_pb2.LegacyMessage.SFM: 'mrData',

        xmlegacy_pb2.LegacyMessage.BK: 'block',
        xmlegacy_pb2.LegacyMessage.FB: 'fbData',
        xmlegacy_pb2.LegacyMessage.PB: 'pbData',

        ############################
        xmlegacy_pb2.LegacyMessage.TX: 'txData',
        xmlegacy_pb2.LegacyMessage.MT: 'mtData',
        xmlegacy_pb2.LegacyMessage.TK: 'tkData',
        xmlegacy_pb2.LegacyMessage.TT: 'ttData',
        xmlegacy_pb2.LegacyMessage.LT: 'ltData',
        xmlegacy_pb2.LegacyMessage.SL: 'slData',

        xmlegacy_pb2.LegacyMessage.EPH: 'ephData',

        xmlegacy_pb2.LegacyMessage.SYNC: 'syncData',

        xmlegacy_pb2.LegacyMessage.MC: 'mcData',
        xmlegacy_pb2.LegacyMessage.MS: 'msData',
        xmlegacy_pb2.LegacyMessage.MV: 'mvData',
    }
    ...
    def get(self, msg_type, msg_hash: bytes) -> Optional[xmlegacy_pb2.LegacyMessage]:
        if not self.contains(msg_hash, msg_type):
            return None

        msg = self._hash_msg[msg_hash].msg
        data = xmlegacy_pb2.LegacyMessage(**{'func_name': msg_type,
