...
from pyxmlib import pyxmlib
from pyxmlib.pyxmlib import bin2hstr, getRandomSeed, str2bin, bin2mnemonic, mnemonic2bin  # noqa
from pyxmlib.pyxmlib import XmssFast, xmDescriptor

hash_functions = {
    "shake128": pyxmlib.SHAKE_128,
    "shake256": pyxmlib.SHAKE_256,
    "sha2_256": pyxmlib.SHA2_256
}
...
class XMSS(object):
    ...
    def from_extended_seed(extended_seed: bytes):
        ...
        descr = xmDescriptor.fromBytes(extended_seed[0:3])
        if descr.getSignatureType() != pyxmlib.XMSS:
    ...
    def __init__(self, _xmssfast):
        ...
        >>> from xm.crypto.doctest_data import *
