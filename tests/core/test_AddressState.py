...
from tests.misc.helper import get_alice_xmss, get_slave_xmss, get_random_xmss, set_xm_dir
...
class TestAddressState(TestCase):
    ...
    @patch('xm.core.AddressState.AddressState.transaction_hashes', new_callable=PropertyMock)
