...
from xm.core.Miner import Miner
from xm.core.TransactionPool import TransactionPool
from xm.core.misc.helper import parse_qaddress
...
class TestMiner(TestCase):
    ...
    def test_start_mining_works(self, m_getTime, m_logger):
        ...
        with patch('xm.core.miners.qryptonight7.CNv1Miner.CNv1Miner.start', spec=True) as m_start:
...
class TestMinerWithRealTransactionPool(TestCase):
    ...
    @patch('xm.core.Miner.Block.create')
